...
if (isset($_POST['issent'])) {
	$errmsg = "Следующие колонки должны быть обязательно заполнены :<br/><br/>";
	$message = $errmsg;
	$controle = false;
   ...
   if ($controle==true) {
	echo "<div class='inblock'>";
        echo "<h3>Формуляр отправлен</h3>";
	echo "Мы Вам ответим кротчайший срок по адресу ".$_SESSION['email']."<br />";
	echo "</div>"; 
	}
}